import type { Artwork, Photograph, Poem } from "./types";
...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    date: "June 2025",
    tags: ["fanart", "alien-stage"],
  },
  {
    slug: "zheng-bei-x-jiang-xiaohai",
    title: "郑北x姜小海 Fanart",
    medium: "Digital Art",
  ...
  },
  {
    ...
    description: "If I cannot inspire love, I will cause fear.",
    date: "January 2025",
    tags: ["oc"],
  },
  {
    slug: "love-me-hate-me",
    title: "Love me, Hate me",
    medium: "Digital Design",
    image: "/art/jeonghan.JPEG",
    description: "Photoshop album design for Seventeen's Jeonghan.",
    date: "March 2023",
    tags: ["seventeen"],
  },
  {
    slug: "describe-what-you-see",
    title: "Describe what you see",
    medium: "Digital Design",
    image: "/art/vernon.JPEG",
    description:
      "Photoshop album design for Seventeen's Vernon, inspired by Dead Poets Society.",
    date: "March 2023",
    tags: ["seventeen", "dead-poets-society"],
  },
  {
    slug: "commission-1",
    title: "Commission 1",
    ...
    description: "Commissioned art for online friends, part 1.",
    date: "August 2024",
    tags: ["commission"],
  },
  {
    ...
    medium: "Digital Art",
    image: "/art/idol.JPG",
    description: "Commissioned art for online friends, part 2.",
    date: "August 2024",
    tags: ["commission"],
  },
  {
    ...
    medium: "Digital Art",
    image: "/art/fairy.JPG",
    description: "Commissioned art for online friends, part 3.",
    date: "August 2024",
    tags: ["commission"],
  },
  {
    ...
    description: "Commissioned art for online friends, part 4.",
    date: "August 2024",
    tags: ["commission"],
  },
  {
  ...
  },
  {
    ...
    medium: "Digital Art",
    image: "/art/am-i-pretty-now.png",
    description: "Mizi, Candy Scar Face — a smile held too tightly.",
    date: "2026",
    tags: ["fanart", "alien-stage"],
  },
  {
    slug: "two-hundred-fifty",
    title: "Two Hundred Fifty",
    medium: "Digital Art",
    image: "/art/two-hundred-fifty.png",
    description: "Alfred, looking forward — a birthday drawn like a quiet oath.",
    date: "2026",
    tags: ["fanart", "hetalia"],
  },
  {
    ...
    title: "Romemok",
    medium: "Digital Art",
    image: "/art/romemok.png",
    description: "William and Est — two names pressed into one groove.",
    date: "2026",
    tags: ["fanart"],
  },
  {
    ...
    title: "Emblems",
    medium: "Digital Design",
    image: "/art/oc-emblems.png",
    description: "Marks for the ones who live in the margins of the story.",
    date: "2026",
    tags: ["oc", "design"],
  },
  {
    slug: "ioakun-mycoto-marks",
    title: "Hold Me. Haunt Me.",
    medium: "Digital Design",
    image: "/art/ioakun-mycoto-marks.png",
    description: "Studio marks — Ioakun, Mycoto, the web between names.",
    date: "2026",
    tags: ["oc", "design"],
  },
  {
    ...
    title: "Zion, Again",
    medium: "Digital Art",
    image: "/art/zion-again.png",
    description: "The apprentice returns as static — halo still tilted.",
    date: "2026",
    tags: ["oc"],
  },
  {
    ...
    image: "/art/creep.png",
    description: "The quieter confession — not belonging, and saying it out loud.",
    date: "2026",
    tags: ["self"],
  },
  {
    slug: "soul-rotting",
    title: "I Feel My Soul Rotting Away",
    medium: "Digital Art",
    image: "/art/soul-rotting.png",
    description: "A smile that does not reach the hands at the throat.",
    date: "2026",
    tags: ["self"],
  },
  {
    slug: "empty-empty-empty",
    title: "Empty, Empty, Empty",
    medium: "Digital Collage",
    image: "/art/new-year-2026.png",
    description: "A New Year found in the notes app — empty, and still asking.",
    date: "2026",
    tags: ["self"],
  },
  {
    slug: "mycoto-shapeshift",
    title: "Still Her",
    medium: "Digital Art",
    image: "/art/mycoto-shapeshift.png",
    description: "Two faces, one bandage — still her.",
    date: "2026",
    tags: ["oc"],
  },
  {
    ...
    title: "Ocean Eyes",
    medium: "Digital Art",
    image: "/art/ocean-eyes.png",
    description: "William — letterboxed light on the water of a glance.",
    date: "2026",
    tags: ["fanart"],
  },
  {
    slug: "journey-towards-death",
    title: "A Journey Towards Death",
    medium: "Digital Art",
    image: "/art/journey-towards-death.png",
    description: "Birth to death in one orbit — crown, void, and the road between.",
    date: "2026",
    tags: ["oc"],
  },
  {
    ...
    medium: "Digital Collage",
    image: "/art/liqi.png",
    description: "For Sara — a scrapbook that keeps her light.",
    date: "2026",
    tags: ["portrait"],
  },
];
...
export const photographs: Photograph[] = [
  { slug: "hello", title: "Hello", category: "Portrait", image: "/photography/hello.JPG" },
  { slug: "dragon-boat", title: "Dragon Boat", category: "Event", image: "/photography/dragonBoat.jpg" },
  { slug: "characters", title: "Characters", category: "Portrait", image: "/photography/characters.jpg" },
  { slug: "car-blur", title: "Car Blur", category: "Urban", image: "/photography/car_blurr.png" },
  { slug: "train", title: "Train", category: "Urban", image: "/photography/Zhang_train.jpg" },
  { slug: "texture", title: "Texture", category: "Abstract", image: "/photography/Zhang_texture.jpg" },
  { slug: "red-dancers", title: "Red Dancers", category: "Dance", image: "/photography/Zhang_redDancers.jpg" },
  { slug: "portrait-2", title: "Portrait 2", category: "Portrait", image: "/photography/Zhang_portrait2.jpg" },
  { slug: "pool-jump", title: "Pool Jump", category: "Action", image: "/photography/Zhang_poolJump-min.png" },
  { slug: "pepper", title: "Pepper", category: "Still Life", image: "/photography/Zhang_pepper.png" },
  { slug: "deer", title: "Deer", category: "Wildlife", image: "/photography/Zhang_deer.jpg" },
  { slug: "dance-again", title: "Dance Again", category: "Dance", image: "/photography/Zhang_danceAgain-min.jpg" },
  { slug: "dance-3", title: "Dance 3", category: "Dance", image: "/photography/Zhang_dance3.jpg" },
  { slug: "dance-2", title: "Dance 2", category: "Dance", image: "/photography/Zhang_dance2.jpg" },
  { slug: "dance", title: "Dance", category: "Dance", image: "/photography/Zhang_dance.jpg" },
  { slug: "dance-2-copy", title: "Dance 2 (Copy)", category: "Dance", image: "/photography/Zhang_dance (2).jpg" },
  { slug: "butterfly", title: "Butterfly", category: "Nature", image: "/photography/Zhang_butterfly.jpg" },
  { slug: "bok-choy", title: "Bok Choy", category: "Still Life", image: "/photography/Zhang_bok choy.png" },
  { slug: "blurry", title: "Blurry", category: "Abstract", image: "/photography/Zhang_blurry.jpg" },
  { slug: "we-the-people", title: "We The People", category: "Portrait", image: "/photography/Zhang_WeThePeople.jpg" },
  { slug: "shiny-beach", title: "Shiny Beach", category: "Beach", image: "/photography/Zhang_ShinyBeach-min.png" },
  { slug: "portal", title: "Portal", category: "Abstract", image: "/photography/Zhang_Portal.jpg" },
  { slug: "molly", title: "Molly", category: "Portrait", image: "/photography/Zhang_Molly.jpg" },
  { slug: "michelle-at-beach", title: "Michelle At Beach", category: "Beach", image: "/photography/Zhang_MichelleAtBeach-min.png" },
  { slug: "cupcake", title: "Cupcake", category: "Still Life", image: "/photography/Zhang_Cupcake.png" },
  { slug: "coca-cola", title: "Coca Cola", category: "Still Life", image: "/photography/Zhang_CocaCola.jpg" },
  { slug: "cabbage", title: "Cabbage", category: "Still Life", image: "/photography/Zhang_Cabbage.png" },
  { slug: "anna", title: "Anna", category: "Portrait", image: "/photography/Zhang_Anna.jpg" },
];

export const poems: Poem[] = [
  {
    slug: "that-flowers-fall",
...
Below the roof one drinks, and a query was made to one's own heart`,
  ...
  {
    slug: "romantic-death-linguistic-tragedy",
...
through all the cracks, and I'm awake.`,
  ...
  {
    slug: "love-is-the-language-of-strangers",
